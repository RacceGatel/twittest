...
return [
    ...
    */
    ...
    'processes' => [
        'send_twits' => [ // Key name is process name
            'class'    => \App\Processes\TwitSendProcess::class,
    ...
    */
    ...
    'swoole_tables' => [
        'cat_fd' => [// The Key is table name, will add suffix "Table" to avoid naming conflicts. Here defined a table named "wsTable"
